...
func GetVoteAnswersTable(ctx *context.Context) table.Table {
	...
	info.SetTable("voteAnswers").SetTitle("VoteAnswers").SetDescription("VoteAnswers")
	...
	formList.SetTable("voteAnswers").SetTitle("VoteAnswers").SetDescription("VoteAnswers")
